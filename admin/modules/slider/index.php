...
function slider_wp_enqueue_scripts(){
    wp_register_style( 'slick-style', get_template_directory_uri().'/admin/modules/slider/css/slick.css');
    wp_register_script( 'slick-script', get_template_directory_uri().'/admin/modules/slider/js/slick.min.js',array('jquery'));
    wp_register_script( 'slick-slider', get_template_directory_uri().'/admin/modules/slider/js/slick-slider.js',array('slick-script'));
}
