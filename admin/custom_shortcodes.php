...
<div class="container-fluid book_now_banner">
  <div class="container">
    <div class="row ">
      <div class="col '.$col_left.' col-sm-12"><span class="book_now_text">'. $title .'</span></div>
      <div class="col '.$col_right.' col-sm-12"><a class="button" href="'. $buttonurl .'">'. $buttontitle .'</a></div>
    </div>
  </div>
</div>';
}
